...
class OnsSpider(scrapy.Spider):
    name = 'onsProducaoTermica'
    start_urls = ['http://www.ons.org.br/resultados_operacao/SDRO/Diario/2017_02_01/HTML/08_ProducaoTermicaUsina.html']
    ...
    def parse(self, response):
        ...
        if (self.refDate <date.today()):
            ...
            if(self.refDate<date(2017, 5, 16)):
                 ...
                 item='09'  
            url='http://www.ons.org.br/resultados_operacao/SDRO/Diario/{0}_{1}_{2}/HTML/{3}_ProducaoTermicaUsina.html'.format(self.refDate.year,mes,dia,item)
