...
class OnsSpider(scrapy.Spider):
    name = 'onsProducaoEolica'
    start_urls = ['http://www.ons.org.br/resultados_operacao/SDRO/Diario/2017_02_01/HTML/09_ProducaoEolicaUsina.html']
    ...
    def parse(self, response):
        ...
        if (self.refDate <date.today()):
            ...
            if(self.refDate<date(2017, 5, 16)):
                 ...
                 item='10'  
            url='http://www.ons.org.br/resultados_operacao/SDRO/Diario/{0}_{1}_{2}/HTML/{3}_ProducaoEolicaUsina.html'.format(self.refDate.year,mes,dia,item)
